	...
	<div id="page" class="site">
		...
		<style>
            .grid-body {
                ...
                border: 1px solid #ccc; /* Añadir un borde alrededor del contenido */
                padding: 15px; /* Añadir espacio alrededor del contenido */
            }

            .grid-img {
                border: 1px solid #ccc; /* Añadir un borde a la imagen */
                padding: 15px; /* Añadir espacio alrededor de la imagen */
                display: inline-block; /* Evitar que el borde ocupe todo el ancho */
            }
        </style>
                ...
                <div class="grid-container" itemscope itemtype="http://schema.org/Event">
                    <div class="grid-box-wrap">
                        ...
                        <div class="grid-body">
                            ...
                            <h1 itemprop="name">Beca Universal para el Bienestar Benito Juárez de Educación Media Superior</h1>
                            <p itemprop="description">
                                La Beca Universal para el Bienestar Benito Juárez de Educación Media Superior es un programa del Gobierno de México dirigido a las y los alumnos de educación
                                 media superior inscritas o inscritos en escuelas públicas en modalidad
                                escolarizada o mixta para que continúen y concluyan sus estudios.
                            </p>

                            <a href="https://www.gob.mx/becasbenitojuarez/articulos/beca-benito-juarez-para-jovenes-de-educacion-media-superior-216589">Más información
